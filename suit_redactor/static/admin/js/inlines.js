...
(function($) {
  $.fn.formset = function(opts) {
    ...
    var updateElementIndex = function(el, prefix, ndx) {
      ...
      // Script nodes aren't being processed. The Redactor widget is
      // initialized with JavaScript and has to target a node that was
      // generated by this code, so we'll replace the contents of the
      // JavaScript as well.
      if (el.nodeName.toLowerCase() == 'script') {
        el.text = el.text.replace(id_regex, replacement);
      }
    };
